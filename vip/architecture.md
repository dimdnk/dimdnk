# Venue Intelligence Platform (VIP) — Architecture Reference
...
Extend `foundation-ui-app` — do **not** fork. New VIP features live under:
...
Both VIP services follow foundation patterns exactly.
